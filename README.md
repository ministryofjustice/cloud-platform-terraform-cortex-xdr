...
| <a name="input_infrastructure_support"></a> [infrastructure\_support](#input\_infrastructure\_support) | n/a | `string` | `""` | no |
...
| <a name="input_team_name"></a> [team\_name](#input\_team\_name) | n/a | `string` | `""` | no |
